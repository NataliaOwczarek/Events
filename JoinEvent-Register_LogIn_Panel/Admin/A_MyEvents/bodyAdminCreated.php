...
if ($result->num_rows > 0) {
    ...
    if ($result->num_rows === 0) {
        ...
        echo "<a href='../A_MyEvents/AdminAddEvent.php' class='btn btn-primary' style='background-color: #444; color: #fff; border: none;'>Stwórz wydarzenie</a>";
        echo "</div>";
        echo "</div>";
        echo "</div>";
        echo "</div>";
...
async function deleteEvent(eventId) {
    try {
        const response = await fetch(`../A_Event/RemoveEvent.php?eventId=${eventId}`);
                ...
                <div class='row justify-content-center'>
                    <div class='col-md-8 text-center'>
                        <div class='alert alert-secondary' role='alert'>
                            ...
                            <a href='../A_MyEvents/AdminAddEvent.php' class='btn btn-primary' style='background-color: #444; color: #fff; border: none;'>Stwórz wydarzenie</a></a>
                        </div>
                    </div>
                </div>
            `;
