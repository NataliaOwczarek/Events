...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<a href='../A_Event/AdminEventDetails.php?id={$row['EventId']}' class='btn btn-secondary'>Szczegóły wydarzenia</a>";
    ...
    // Informacja, gdy użytkownik nie uczestniczył w żadnych przeszłych wydarzeniach
