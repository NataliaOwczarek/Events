    ...
    <div class="header">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark">
                <a class="navbar-brand" href="../U_Home/UserHome.php">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="../../User/U_Home/UserHome.php">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../../User/U_About/UserAbout.php">About</a>
                        </li>
                        <li class="nav-item dropdown custom-dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMyEvents">
                                <li><a class="dropdown-item" href="../U_MyEvents/UserAddEvent.php">Add Event</a></li>
                                <li><a class="dropdown-item" href="../U_MyEvents/UserFavourites.php">Favourites</a></li>
                                <li><a class="dropdown-item" href="../U_MyEvents/UserCreated.php">Created by me</a></li>
                                <li><a class="dropdown-item" href="../U_MyEvents/UserArchiwum.php">Archiwum</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../U_Menu/UserEditProfile.php">Edit Profile</a>
                        </li>
                    </ul>
                    <ul class="navbar-nav ms-auto"> 
                        <li class="nav-item">
                            <a class="nav-link" href="../../Admin/A_Menu/UserProfile.php?user_id=<?php echo  $userId;?>&action=none">
                                <div>
